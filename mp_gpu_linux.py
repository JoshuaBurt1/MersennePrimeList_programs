...
# Next step is to move Lucas-Lehmer to GPU
ARRAY_SIZE = 2000           # Total range per batch
CHUNK_SIZE = 1000           # Primes per GPU kernel launch
FACTOR_UP_TO = 30000        # 2000:20000 = 18.1s; 2000:30000 = 17.6s; 2000:50000 = 18.1s; 2000:100000 = 19.1s
ORIGINS = [5, 7, 11, 13]    # 4000:10000 = 156.2s; 4000:100000 = 154.8s; 4000:200000 = 157.8s
OFFSET = 120                
...
# Mega-Kernel with 128-bit support enabled via options
...
''', 'mega_sieve', options=('--device-int128',))
